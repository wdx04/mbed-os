...
/* Region 2 setting */
    ...
    MPU->RASR = ARM_MPU_RASR(0, ARM_MPU_AP_FULL, 0, 0, 1, 1, 0, ARM_MPU_REGION_SIZE_64B);
...
{
    return BOARD_BOOTCLOCKRUN_PERCLK_CLK_ROOT;
}
...
void MBED_DelayAtLeastUs(uint32_t delay_us)
{
