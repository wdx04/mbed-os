...
agt_instance_ctrl_t g_timer_agt5_ctrl;
const agt_extended_cfg_t g_timer_agt5_extend =
{
...
const timer_cfg_t g_timer_agt5_cfg =
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.00131072 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)TIMER_SOURCE_DIV_8,
    .channel             = 5,
    .p_callback          = NULL,
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_agt5 =
{
    .p_ctrl        = &g_timer_agt5_ctrl,
    .p_cfg         = &g_timer_agt5_cfg,
    .p_api         = &g_timer_on_agt
};
agt_instance_ctrl_t g_timer_agt3_ctrl;
...
const timer_cfg_t g_timer_agt3_cfg =
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.00131072 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)TIMER_SOURCE_DIV_8,
    .channel             = 3,
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_agt3 =
{
    .p_ctrl        = &g_timer_agt3_ctrl,
    .p_cfg         = &g_timer_agt3_cfg,
    .p_api         = &g_timer_on_agt
};
agt_instance_ctrl_t g_timer_agt2_ctrl;
const agt_extended_cfg_t g_timer_agt2_extend =
{
    .count_source            = AGT_CLOCK_PCLKB,
    .agto                    = AGT_PIN_CFG_DISABLED,
    .agtoab_settings_b.agtoa = AGT_PIN_CFG_START_LEVEL_LOW,
...
const timer_cfg_t g_timer_agt2_cfg =
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.00131072 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)TIMER_SOURCE_DIV_8,
    .channel             = 2,
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_agt2 =
{
    .p_ctrl        = &g_timer_agt2_ctrl,
    .p_cfg         = &g_timer_agt2_cfg,
    .p_api         = &g_timer_on_agt
};
...
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.00065536 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)TIMER_SOURCE_DIV_64,
    .channel             = 5,
    .p_callback          = NULL,
    /** If NULL then do not add & */
#if defined(NULL)
...
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.00065536 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)TIMER_SOURCE_DIV_4,
    .channel             = 2,
    .p_callback          = NULL,
    /** If NULL then do not add & */
#if defined(NULL)
...
/** SPI extended configuration for SCI SPI HAL driver */
const sci_spi_extended_cfg_t g_spi_sci0_ext_cfg =
{
    .clk_div = {
        /* Actual calculated bitrate: 1041666. */ .cks = 0, .brr = 11, .mddr = 0,
    }
};

/** SPI configuration for SCI SPI HAL driver */
const spi_cfg_t g_spi_sci0_cfg =
{
    ...
    .p_context           = NULL,
    .p_extend            = (void *)&g_spi_sci0_ext_cfg,
};

/* Instance structure to use this module. */
const spi_instance_t g_spi_sci0 =
{
    .p_ctrl          = &g_spi_sci0_ctrl,
    .p_cfg           = &g_spi_sci0_cfg,
    .p_api           = &g_spi_on_sci
};
...
{
    /* Actual delay: 260 ns. */ .clock_settings.brl_value = 13, .clock_settings.digital_filter_stages = 3, .clock_settings.cks_value = 0,
};
...
#undef RA_NOT_DEFINED
    ...
    .p_extend            = &g_i2c_slave0_extend,
};
/* Instance structure to use this module. */
const i2c_slave_instance_t g_i2c_slave0 =
{
    .p_ctrl        = &g_i2c_slave0_ctrl,
    .p_cfg         = &g_i2c_slave0_cfg,
    .p_api         = &g_i2c_slave_on_iic
};
...
const timer_cfg_t g_timer_gpt1_cfg =
{
    ...
    /* Actual period: 42.94967296 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x100000000, .duty_cycle_counts = 0x80000000, .source_div = TIMER_SOURCE_DIV_4,
    .channel             = 1,
