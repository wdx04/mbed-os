...
extern agt_instance_ctrl_t g_timer_agt5_ctrl;
extern const timer_cfg_t g_timer_agt5_cfg;

#ifndef NULL
void NULL(timer_callback_args_t * p_args);
#endif
/** AGT Timer Instance */
extern const timer_instance_t g_timer_agt3;

/** Access the AGT instance using these structures when calling API functions directly (::p_api is not used). */
extern agt_instance_ctrl_t g_timer_agt3_ctrl;
extern const timer_cfg_t g_timer_agt3_cfg;

#ifndef NULL
void NULL(timer_callback_args_t * p_args);
#endif
/** AGT Timer Instance */
extern const timer_instance_t g_timer_agt2;

/** Access the AGT instance using these structures when calling API functions directly (::p_api is not used). */
extern agt_instance_ctrl_t g_timer_agt2_ctrl;
extern const timer_cfg_t g_timer_agt2_cfg;
