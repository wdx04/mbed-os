...
#define R_CANFD_CFG_H_
            ...
            #define CANFD_CFG_GLOBAL_ERROR_CH    (config.driver.canfd.global_err.cb_channel.0)
            ...
            #define CANFD_CFG_RXFIFO0_DEPTH         ()
            ...
            #define CANFD_CFG_RXFIFO1_DEPTH         ()
            ...
            #define CANFD_CFG_RXFIFO2_DEPTH         ()
            ...
            #define CANFD_CFG_RXFIFO3_DEPTH         ()
            ...
            #define CANFD_CFG_RXFIFO4_DEPTH         ()
            ...
            #define CANFD_CFG_RXFIFO5_DEPTH         ()
            ...
            #define CANFD_CFG_RXFIFO6_DEPTH         ()
            ...
            #define CANFD_CFG_RXFIFO7_DEPTH         ()
            ...
            #define CANFD_CFG_COMMONFIFO0 (((0) << R_CANFD_CFDCFCC_CFE_Pos) | \
                                                    ...
                                                    ( << R_CANFD_CFDCFCC_CFTML_Pos) | \
                                                    ( << R_CANFD_CFDCFCC_CFDC_Pos) | \
