...
const spi_extended_cfg_t g_spi1_ext_cfg =
{
    ...
    .burst_interframe_delay = SPI_BURST_TRANSFER_WITHOUT_DELAY
 };
...
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.00131072 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)0,
    .channel             = 1,
    .p_callback          = NULL,
    /** If NULL then do not add & */
#if defined(NULL)
...
sci_uart_instance_ctrl_t     g_uart0_ctrl;
            ...
            {
                .clock                = SCI_UART_CLOCK_INT_WITH_BAUDRATE_OUTPUT,
                .rx_edge_start          = SCI_UART_START_BIT_FALLING_EDGE,
                .noise_cancel         = SCI_UART_NOISE_CANCELLATION_DISABLE,
                .rx_fifo_trigger        = SCI_UART_RX_FIFO_TRIGGER_MAX,
...
const timer_cfg_t g_timer_gpt1_cfg =
{
    ...
    /* Actual period: 0.00065536 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)TIMER_SOURCE_DIV_16,
    .channel             = 1,
