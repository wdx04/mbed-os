...
{
    /* Actual bitrate: 500000 Hz. Actual sample point: 76 %. */
...
{
    /* Actual bitrate: 1923077 Hz. Actual sample point: 77 %. */
    .baud_rate_prescaler = 1,
    .time_segment_1 = 9,
    .time_segment_2 = 3,
...
canfd_global_cfg_t g_canfd0_global_cfg =
{
    ...
    .rx_fifo_config =
    {
        ...
        ((3U) << R_CANFD_CFDRFCC_RFIGCV_Pos) | ((2) << R_CANFD_CFDRFCC_RFDC_Pos) | ((7) << R_CANFD_CFDRFCC_RFPLS_Pos) | ((R_CANFD_CFDRFCC_RFIE_Msk | R_CANFD_CFDRFCC_RFIM_Msk)) | ((0))
    },
    .common_fifo_config =
    {
...
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.0006826666666666667 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)TIMER_SOURCE_DIV_64,
    .channel             = 3,
    .p_callback          = NULL,
...
const iic_b_master_extended_cfg_t g_i2c_master0_extend =
{
    ...
    .smbus_operation         = 0,
    /* Actual calculated bitrate: 99892. Actual calculated duty cycle: 50%. */ .clock_settings.brl_value = 234, .clock_settings.brh_value = 233, .clock_settings.cks_value = 1, .clock_settings.sdod_value = 0, .clock_settings.sdodcs_value = 0, .iic_clock_freq = 48000000,
};
...
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.0013653333333333334 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)TIMER_SOURCE_DIV_8,
    .channel             = 1,
    .p_callback          = NULL,
    /** If NULL then do not add & */
#if defined(NULL)
...
sci_uart_instance_ctrl_t     g_uart0_ctrl;
            ...
            {
                /* Baud rate calculated with 0.160% error. */ .semr_baudrate_bits_b.abcse = 0, .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 51, .mddr = (uint8_t) 256, .semr_baudrate_bits_b.brme = false
            };
...
const timer_cfg_t g_timer_gpt1_cfg =
{
    ...
    /* Actual period: 0.0006826666666666667 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)TIMER_SOURCE_DIV_32,
    .channel             = 1,
