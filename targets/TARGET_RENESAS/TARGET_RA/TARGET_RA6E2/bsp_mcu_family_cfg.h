...
#define BSP_TZ_CFG_LPMSAR ((1 > 0) ? 0xFFFFDCEAU : 0xFFFFFFFFU)
#endif
            /* Deep Standby Interrupt Factor Security Attribution Register. */
#ifndef BSP_TZ_CFG_DPFSAR
#define BSP_TZ_CFG_DPFSAR ((1 > 0) ? 0xFAE0A00CU : 0xFFFFFFFFU)
#endif
...
#define BSP_TZ_CFG_ICUSARE ((1 > 0) ? 0x84F2FFFFU : 0xFFFFFFFFU)
#endif

            /* Security attribution registers for WUPEN1. */
#ifndef BSP_TZ_CFG_ICUSARF
#define BSP_TZ_CFG_ICUSARF ((1 > 0) ? 0xFFFFF7FFU : 0xFFFFFFFFU)
#endif
