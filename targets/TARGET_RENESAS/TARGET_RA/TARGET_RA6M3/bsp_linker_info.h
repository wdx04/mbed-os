...
extern uint32_t __sdram_from_qspi_flash$$Base;
extern uint32_t __sdram_from_qspi_flash$$Limit;
extern uint32_t __sdram_from_qspi_flash$$Load;
...
{
  {.p_base = &__sdram_from_qspi_flash$$Base, .p_limit = &__sdram_from_qspi_flash$$Limit, .p_load = &__sdram_from_qspi_flash$$Load,.type={.copy_64 = 0, .external = 1, .source_type = INIT_MEM_QSPI_FLASH, .destination_type = INIT_MEM_SDRAM}},
