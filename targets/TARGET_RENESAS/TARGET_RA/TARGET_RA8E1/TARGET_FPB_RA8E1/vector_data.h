...
/* generated vector header file - do not edit */
        ...
        #define VECTOR_DATA_IRQ_COUNT    (69)
        #endif
        /* ISR prototypes */
        ...
        #define VECTOR_NUMBER_FCU_FRDYI ((IRQn_Type) 67) /* FCU FRDYI (Flash ready interrupt) */
        #define FCU_FRDYI_IRQn          ((IRQn_Type) 67) /* FCU FRDYI (Flash ready interrupt) */
        #define VECTOR_NUMBER_FCU_FIFERR ((IRQn_Type) 68) /* FCU FIFERR (Flash access error interrupt) */
        #define FCU_FIFERR_IRQn          ((IRQn_Type) 68) /* FCU FIFERR (Flash access error interrupt) */
        /* The number of entries required for the ICU vector table. */
        #define BSP_ICU_VECTOR_NUM_ENTRIES (69)
