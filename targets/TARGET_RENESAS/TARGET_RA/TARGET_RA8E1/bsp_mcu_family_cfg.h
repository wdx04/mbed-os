...
#define BSP_TZ_CFG_ICUSARE ((1 > 0) ? 0U : 0xFB1D0000U)
#endif

            /* Security attribution registers for WUPEN1. */
#ifndef BSP_TZ_CFG_ICUSARF
#define BSP_TZ_CFG_ICUSARF ((1 > 0) ? 0U : 0x00007708U)
#endif
