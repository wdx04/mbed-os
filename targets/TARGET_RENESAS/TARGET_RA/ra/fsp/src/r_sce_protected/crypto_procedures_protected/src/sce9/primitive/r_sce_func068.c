...
void R_SCE_func068(void)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    R_SCE_func100(0xe6b68cd4U, 0xf4f72556U, 0x97e00a50U, 0x44ef2fa0U);
    ...
    R_SCE_func100(0x4b48b267U, 0x75c1d1afU, 0xe49c17d3U, 0xc0bf38eeU);
    SCE->REG_ECH = 0x00008d40U;
    SCE->REG_ECH = 0x00ffffffU;
    SCE->REG_ECH = 0x00009140U;
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_func068.prc
***********************************************************************************************************************/
