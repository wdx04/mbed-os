...
void R_SCE_func300(void)
{
    ...
    R_SCE_func100(0x5827b5e6U, 0x0adbb8bcU, 0x19dc3fa5U, 0x96422a70U);
    ...
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0xde0601d6U, 0x4441332eU, 0x2b790f35U, 0x2f0f54b5U);
    }
    ...
    SCE->REG_E0H = 0x00000080U;
    SCE->REG_1CH = 0x00260000U;
    R_SCE_func100(0xe17382d4U, 0xbc2b724aU, 0x63719741U, 0xb4b36a4cU);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0xb77c8511U, 0x8a463943U, 0x9f12e57dU, 0x56cf6d7eU);
    }
    ...
    SCE->REG_E0H = 0x00000080U;
    SCE->REG_1CH = 0x00260000U;
    R_SCE_func100(0x55b85d63U, 0x06dc5aafU, 0xaa747e02U, 0xe5f690e2U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0x26a1ab54U, 0xbb20a26dU, 0xcd1c0658U, 0x9aaf461eU);
    }
    else
    {
        ...
        R_SCE_func101(0x4ccf6a83U, 0xb60b8ac2U, 0x0bcb5d75U, 0xb09976b8U);
    }
    SCE->REG_24H = 0x0000302cU;
    /* WAIT_LOOP */
    while (0U != SCE->REG_24H_b.B21)
    ...
    SCE->REG_E0H = 0x00000080U;
    SCE->REG_1CH = 0x00260000U;
    R_SCE_func100(0x32b56529U, 0x5359ec29U, 0xddf89049U, 0xdf307b63U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0x6251bf0bU, 0x5e47c602U, 0x4cd52464U, 0x0ce0b253U);
    }
    else
    {
        SCE->REG_34H = 0x00000800U;
        ...
        R_SCE_func101(0xdbc3b158U, 0xcc77e34bU, 0x7a89b27bU, 0x26839762U);
    }
    ...
    SCE->REG_E0H = 0x00000080U;
    SCE->REG_1CH = 0x00260000U;
    R_SCE_func100(0x9c30351fU, 0x8c746876U, 0x763e30c3U, 0x507e7d42U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0x5ad49836U, 0x5ec75f50U, 0x6a6eb10fU, 0xeb16cfecU);
    }
    else
    {
        SCE->REG_34H = 0x00000800U;
        ...
        R_SCE_func101(0x71c2236dU, 0x7f7565c3U, 0xed8c9b2fU, 0x488aec92U);
    }
    SCE->REG_ECH = 0x38000bc4U;
    SCE->REG_E0H = 0x00000080U;
    SCE->REG_1CH = 0x00260000U;
    R_SCE_func100(0x0e28e871U, 0x68911775U, 0x5c0e2a26U, 0x1f46065cU);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        SCE->REG_ECH = 0x00002f80U;
        R_SCE_func100(0x90fc5456U, 0x1ec510acU, 0x589f1800U, 0x24194fb2U);
    ...
    else
    {
        ...
        SCE->REG_E0H = 0x00000080U;
        SCE->REG_1CH = 0x00260000U;
        R_SCE_func100(0xb4bf4fe6U, 0xe992d7cfU, 0xca7e0753U, 0xe53f79feU);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            R_SCE_func101(0xc99853e5U, 0xed2a9a6dU, 0xe8057ea8U, 0xc93d3893U);
        }
        else
        {
            SCE->REG_24H = 0x0000e0c1U;
            ...
            R_SCE_func101(0xe54de8c1U, 0x6539c53eU, 0x6a2045c0U, 0xbe5f6b21U);
        }
        SCE->REG_24H = 0x0000302cU;
        /* WAIT_LOOP */
        while (0U != SCE->REG_24H_b.B21)
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_func300.prc
***********************************************************************************************************************/
