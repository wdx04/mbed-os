...
void R_SCE_func302(void)
{
    ...
    R_SCE_func100(0xadf2ea2cU, 0x2e445cf9U, 0x80455996U, 0xf2c38ab7U);
    ...
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        SCE->REG_E0H = 0x00000080U;
        SCE->REG_1CH = 0x00A60000U;
        R_SCE_func100(0x23434b1cU, 0xce3d950eU, 0x6044fe6bU, 0xce38fa88U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            R_SCE_func100(0xb5fd619dU, 0xfe8c3303U, 0x1f805e42U, 0x275ec111U);
            SCE->REG_1CH = 0x00400000U;
            SCE->REG_1D0H = 0x00000000U;
            if (1U == (SCE->REG_1CH_b.B22))
            {
                ...
                R_SCE_func101(0x3789ad0cU, 0x3b594634U, 0x547c6e10U, 0xda3cda70U);
            }
            ...
            SCE->REG_E0H = 0x00000080U;
            SCE->REG_1CH = 0x00260000U;
            R_SCE_func100(0xf62a96dfU, 0xc770e449U, 0x270286ddU, 0x9fc8f9a8U);
            SCE->REG_1CH = 0x00400000U;
            SCE->REG_1D0H = 0x00000000U;
            if (1U == (SCE->REG_1CH_b.B22))
            {
                ...
                R_SCE_func101(0x8b2550b4U, 0x9d61e941U, 0xf83539aaU, 0xe6d91e5bU);
            }
            ...
            SCE->REG_E0H = 0x00000080U;
            SCE->REG_1CH = 0x00260000U;
            R_SCE_func100(0x44669171U, 0xfa82b075U, 0x6723b09eU, 0x59504dcbU);
            SCE->REG_1CH = 0x00400000U;
            SCE->REG_1D0H = 0x00000000U;
            if (1U == (SCE->REG_1CH_b.B22))
            {
                ...
                R_SCE_func101(0x2b59b119U, 0xbd294ef6U, 0xf4427e36U, 0xdda42933U);
            }
            else
            {
                ...
                R_SCE_func101(0xd9ca12c5U, 0xb5b78ba5U, 0x4a3858d2U, 0xc4ddd51cU);
            }
            SCE->REG_24H = 0x0000302cU;
            /* WAIT_LOOP */
            while (0U != SCE->REG_24H_b.B21)
            ...
            SCE->REG_E0H = 0x00000080U;
            SCE->REG_1CH = 0x00260000U;
            R_SCE_func100(0x7cbfdc49U, 0x1aebcd31U, 0xee07bf36U, 0xdc042aafU);
            SCE->REG_1CH = 0x00400000U;
            SCE->REG_1D0H = 0x00000000U;
            if (1U == (SCE->REG_1CH_b.B22))
            {
                ...
                R_SCE_func101(0xc52665a7U, 0xbacd9ff5U, 0xdc63ede9U, 0xedd212a4U);
            }
            else
            {
                SCE->REG_34H = 0x00000800U;
                ...
                R_SCE_func101(0x00e44fadU, 0xbf55df48U, 0x64353b5cU, 0xf2ed3fb2U);
            }
            ...
            SCE->REG_E0H = 0x00000080U;
            SCE->REG_1CH = 0x00260000U;
            R_SCE_func100(0xf4b585a8U, 0xabf37af5U, 0x09ee7e4dU, 0xc882e0aaU);
            SCE->REG_1CH = 0x00400000U;
            SCE->REG_1D0H = 0x00000000U;
            if (1U == (SCE->REG_1CH_b.B22))
            {
                ...
                R_SCE_func101(0xf4c24636U, 0x73cb9efcU, 0xcec0a4c3U, 0xd521a281U);
            }
            else
            {
                SCE->REG_34H = 0x00000800U;
                ...
                R_SCE_func101(0x74b5720cU, 0x83ba22c1U, 0xe798de76U, 0xd4038326U);
            }
        }
        else
        {
            R_SCE_func101(0x2065e4eeU, 0x27d63aa6U, 0x38fcdf7eU, 0xb53725dbU);
        }
        SCE->REG_ECH = 0x38000bc4U;
        SCE->REG_E0H = 0x00000080U;
        SCE->REG_1CH = 0x00260000U;
        R_SCE_func100(0x1cfcbb89U, 0x684613d7U, 0x313a1abbU, 0x5f5726f7U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            SCE->REG_ECH = 0x00002f80U;
            R_SCE_func100(0x87f9c856U, 0xc7ca05aaU, 0x6a55a4c9U, 0x2943d6eeU);
        ...
        else
        {
            ...
            R_SCE_func101(0xfa943f43U, 0x37fdd85bU, 0xe56a3104U, 0x9e36ce1dU);
            SCE->REG_ECH = 0x00007c1dU;
            SCE->REG_1CH = 0x00602000U;
        }
    }
    ...
    {
        SCE->REG_ECH = 0x00016c00U;
        R_SCE_func101(0x96a8ace5U, 0xcad1b5d4U, 0x88752ce4U, 0xf9bbba59U);
        SCE->REG_ECH = 0x00007c1dU;
        SCE->REG_1CH = 0x00602000U;
    }
}
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_func302.prc
***********************************************************************************************************************/
