...
void R_SCE_func316(void)
{
    ...
    R_SCE_func100(0x40b7e74cU, 0x3052472cU, 0xec56aed1U, 0x34a95f47U);
    ...
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0x12c11525U, 0x4ee976f3U, 0xffab05bcU, 0x7893a0d4U);
    }
    SCE->REG_ECH = 0x0000b7e0U;
    SCE->REG_ECH = 0x0000001cU;
    SCE->REG_ECH = 0x0000b7a0U;
    SCE->REG_ECH = 0x000000f0U;
    R_SCE_func101(0xea6923e9U, 0xb68fd237U, 0xbbf9f1f5U, 0x197c38b3U);
    R_SCE_func317();
    ...
    R_SCE_func101(0xb21a93beU, 0x208b468dU, 0xc6ad078eU, 0xdc017f7bU);
    R_SCE_func317();
    SCE->REG_24H = 0x000050d0U;
    /* WAIT_LOOP */
    while (0U != SCE->REG_24H_b.B21)
    ...
    R_SCE_func100(0xa448658fU, 0x6c782044U, 0xe71eb7ebU, 0x884a0f9dU);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0x6073cce1U, 0x4146ebfbU, 0x8439025cU, 0x32d89076U);
    }
    else
    {
        SCE->REG_24H = 0x000080c1U;
        ...
        R_SCE_func101(0xcecf1cf1U, 0x438b4c42U, 0x0a9d3608U, 0xc0bb6d6bU);
    }
    SCE->REG_24H = 0x000080c1U;
    /* WAIT_LOOP */
    while (0U != SCE->REG_24H_b.B21)
    ...
    SCE->REG_1CH = 0x00210000U;
    R_SCE_func100(0x302650b1U, 0x54a2bc55U, 0x03697c61U, 0x2f82a689U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0xf0fd1c1eU, 0x24834496U, 0xb1b99c74U, 0xe49ec474U);
    }
    else
    {
        SCE->REG_24H = 0x000080c1U;
        ...
        R_SCE_func101(0x6232b0e4U, 0xd8fd0f9cU, 0xc8078527U, 0x1980ee65U);
    }
    SCE->REG_24H = 0x000080c1U;
    /* WAIT_LOOP */
    while (0U != SCE->REG_24H_b.B21)
    ...
    R_SCE_func100(0x8918301cU, 0xe74dade2U, 0x8fadb8d6U, 0x1f09e06eU);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0xf7220e1dU, 0x35ac4980U, 0x2a65b73cU, 0x3926d84eU);
    }
    else
    {
        SCE->REG_28H = 0x009f0001U;
        ...
        R_SCE_func101(0x97cccc98U, 0x67c74453U, 0x595e71efU, 0xfb494dc5U);
    }
    SCE->REG_28H = 0x009f0001U;
    ...
    R_SCE_func100(0x3a6e7c26U, 0xc218e005U, 0x780a1fa6U, 0x0a58b5f1U);
    ...
    SCE->REG_E0H = 0x00000080U;
    SCE->REG_1CH = 0x00A60000U;
    R_SCE_func100(0xa86f85e5U, 0xa171519bU, 0xaba7e235U, 0x9c01fb92U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        for (oLoop2 = 0; oLoop2 < S_RAM[0]; oLoop2 = oLoop2 + 1)
        {
            ...
            R_SCE_func101(0x28296f58U, 0x09545ac2U, 0x4fb93888U, 0x4d7ad0a0U);
        }
        R_SCE_func101(0x01f2a6ecU, 0xe88edcddU, 0xf2261636U, 0x29218a38U);
    }
    else
    {
        for (oLoop2 = 0; oLoop2 < S_RAM[0]; oLoop2 = oLoop2 + 1)
        {
            ...
            SCE->REG_ECH = 0x00002fe0U;
            R_SCE_func101(0x90b18c78U, 0x65513aceU, 0x64969dbcU, 0xc3b353f1U);
        }
        R_SCE_func101(0xa18a2e97U, 0x59f1b496U, 0x6c213132U, 0x56092fbfU);
    }
    ...
    SCE->REG_E0H = 0x00000080U;
    SCE->REG_1CH = 0x00A60000U;
    R_SCE_func100(0x8c6658a9U, 0x85e48da6U, 0x01c0b839U, 0x5ca27868U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func101(0xc17ead24U, 0x2a699312U, 0x0f92974fU, 0x530c32b7U);
    }
    else
    {
        R_SCE_func101(0xae36c5dcU, 0x355a711cU, 0x64f3a02aU, 0x31bd2d28U);
    }
    SCE->REG_ECH = 0x0000b7c0U;
    SCE->REG_ECH = 0x0000000cU;
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_func316.prc
***********************************************************************************************************************/
