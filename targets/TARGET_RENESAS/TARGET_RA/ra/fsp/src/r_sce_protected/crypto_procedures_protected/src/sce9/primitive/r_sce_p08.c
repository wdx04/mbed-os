...
fsp_err_t R_SCE_GenerateAes256RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    R_SCE_func100(0x2487ce5aU, 0x38d94622U, 0x0e2fa8bbU, 0xe25cb7eaU);
    R_SCE_func103();
    ...
    R_SCE_func101(0x941283a0U, 0xcbbb508cU, 0x2985163aU, 0x71e7670fU);
    R_SCE_func043();
    ...
    SCE->REG_100H = change_endian_long(0x00000008U);
    R_SCE_func101(0xa311e3b1U, 0xcbd4c1c2U, 0xbd415c35U, 0xe9e618f2U);
    R_SCE_func044();
    R_SCE_func100(0xfecf26cbU, 0xf3b63500U, 0x687d5cc8U, 0xcb79510aU);
    ...
    R_SCE_func100(0x6ea1d680U, 0xad017341U, 0xde07b586U, 0x44b219afU);
    R_SCE_func103();
    SCE->REG_104H = 0x00000052U;
    SCE->REG_C4H = 0x01000c84U;
    /* WAIT_LOOP */
    ...
    SCE->REG_1CH = 0x00001800U;
    R_SCE_func100(0xb99ac13dU, 0xab83d1f9U, 0xf4f5b915U, 0x7984e8d9U);
    R_SCE_func103();
    SCE->REG_104H = 0x00000052U;
    SCE->REG_C4H = 0x01000c84U;
    /* WAIT_LOOP */
    ...
    SCE->REG_1CH = 0x00001800U;
    R_SCE_func100(0x242ce73fU, 0xfb6d3483U, 0x65ec8b5fU, 0x76d5f2daU);
    ...
    R_SCE_func102(0xc8370a5eU, 0x4d7f2021U, 0x7e18e458U, 0x2a141e4aU);
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p08_r1.prc
***********************************************************************************************************************/
