...
fsp_err_t R_SCE_Aes128GcmEncryptInitSub(uint32_t *InData_KeyType, uint32_t *InData_KeyIndex, uint32_t *InData_IV)
{
    ...
    R_SCE_func100(0xe6bd48a9U, 0x35f890e1U, 0x0eb48ee0U, 0xd6e5b454U);
    ...
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        R_SCE_func100(0x8166a6f8U, 0x7c5ae97bU, 0xa3ff2ad6U, 0x9674f973U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            R_SCE_func101(0x590a0a66U, 0x9d3c2152U, 0x84920a64U, 0x8ddb814dU);
            R_SCE_func043();
            SCE->REG_ECH = 0x0000b4e0U;
            SCE->REG_ECH = 0x00000005U;
            R_SCE_func101(0xc15dbcc0U, 0x9766df32U, 0xc984dd51U, 0x37cea1b3U);
        }
        else
        {
            ...
            SCE->REG_100H = change_endian_long(0x00000029U);
            R_SCE_func101(0x9400b020U, 0x85587f68U, 0x07c9878bU, 0xe075fa2cU);
            R_SCE_func068();
            SCE->REG_ECH = 0x0000b4e0U;
            SCE->REG_ECH = 0x2a46c04bU;
            R_SCE_func101(0x29b849a3U, 0x982e5234U, 0x97964f42U, 0x5f7b3670U);
        }
        SCE->REG_104H = 0x00000058U;
        SCE->REG_E0H = 0x800103a0U;
        /* WAIT_LOOP */
        ...
        SCE->REG_100H = change_endian_long(0x00000029U);
        R_SCE_func101(0xc3783633U, 0x5e086612U, 0xd585c269U, 0x71f7aee8U);
        R_SCE_func044();
        R_SCE_func100(0x208628f4U, 0xa98648dbU, 0x34926e8dU, 0xe158f78cU);
        ...
        R_SCE_func101(0x4466b958U, 0x39825a7bU, 0x3a476f4aU, 0x9d04060eU);
    }
    else
    {
        SCE->REG_104H = 0x00000368U;
        ...
        SCE->REG_100H = change_endian_long(0x00000029U);
        R_SCE_func101(0x7936f504U, 0xacd107a6U, 0x80b56949U, 0x159bddc0U);
        R_SCE_func059();
        R_SCE_func100(0x0c96ba44U, 0x48b9f981U, 0xb9c3faa1U, 0xf9bf7ed9U);
        SCE->REG_104H = 0x00000362U;
        SCE->REG_D0H = 0x40000000U;
        SCE->REG_C4H = 0x02f087b5U;
        /* WAIT_LOOP */
        ...
        SCE->REG_1CH = 0x00001800U;
        R_SCE_func101(0x725f569bU, 0x71ee1fc9U, 0x24633732U, 0x387483e1U);
    }
    R_SCE_func100(0xd5e2a736U, 0xa07462eaU, 0x728a3e6eU, 0xd0293da4U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        R_SCE_func102(0xb7ceeb14U, 0x98bd7231U, 0x9fc6dc6eU, 0x9ba86139U);
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p29i_r3.prc
***********************************************************************************************************************/
