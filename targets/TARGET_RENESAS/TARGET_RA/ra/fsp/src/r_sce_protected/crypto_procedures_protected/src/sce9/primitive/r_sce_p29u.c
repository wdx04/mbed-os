...
void R_SCE_Aes128GcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    R_SCE_func100(0x3d760ddaU, 0xe5fe1c23U, 0xe075aa85U, 0xa12011d7U);
    ...
    R_SCE_func101(0x60b590cdU, 0xc0d1584cU, 0x05d2c79dU, 0xe410d8fcU);
}

/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p29u_r1.prc
***********************************************************************************************************************/
