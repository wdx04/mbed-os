...
void R_SCE_Aes256GcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    R_SCE_func100(0x9641bbfeU, 0x4a18fb1fU, 0x51c92854U, 0xc5ba2a93U);
    ...
    R_SCE_func101(0x1abb2323U, 0xb0269093U, 0x6215a2ebU, 0x2da03e83U);
}

/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p34u_r1.prc
***********************************************************************************************************************/
