...
fsp_err_t R_SCE_Aes256GcmDecryptInitSub(uint32_t *InData_KeyType, uint32_t *InData_KeyIndex, uint32_t *InData_IV)
{
    ...
    R_SCE_func100(0xf721aa65U, 0x5d8787e6U, 0xa66b69c3U, 0xbf92942cU);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        R_SCE_func102(0x7abe2877U, 0x2f23a3b2U, 0xdb0f69e9U, 0xcfdbaf28U);
    ...
    else
    {
        ...
        SCE->REG_E0H = 0x00000080U;
        SCE->REG_1CH = 0x00260000U;
        R_SCE_func100(0xa0f0c4deU, 0xdab200b7U, 0x5acbaf5dU, 0x716b8640U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            R_SCE_func101(0xaeaee44cU, 0x0352ab08U, 0x574f87e3U, 0x469a5827U);
            R_SCE_func043();
            SCE->REG_ECH = 0x0000b4e0U;
            SCE->REG_ECH = 0x00000007U;
            R_SCE_func101(0x196bbddeU, 0x3a4abd2dU, 0xea140939U, 0x1d56ecfeU);
        }
        else
        {
            SCE->REG_104H = 0x00000068U;
            ...
            SCE->REG_100H = change_endian_long(0x00000036U);
            R_SCE_func101(0x02ab7cd5U, 0x7e524484U, 0xd2d565cbU, 0x461b2544U);
            R_SCE_func068();
            SCE->REG_ECH = 0x0000b4e0U;
            SCE->REG_ECH = 0x85d04999U;
            R_SCE_func101(0x4f3dcce6U, 0xb42d9a57U, 0xfe3b6f4fU, 0x72477687U);
        }
        SCE->REG_104H = 0x00000058U;
        SCE->REG_E0H = 0x800103a0U;
        /* WAIT_LOOP */
        ...
        SCE->REG_100H = change_endian_long(0x00000036U);
        R_SCE_func101(0x8e858f1dU, 0x4eabe477U, 0x4e7dff87U, 0x8b34b8f8U);
        R_SCE_func044();
        ...
        SCE->REG_1CH = 0x00001800U;
        R_SCE_func100(0xeebf1c66U, 0xbbfb2950U, 0x4c3b19a3U, 0x2e328634U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            R_SCE_func102(0x212063b9U, 0x2fade8c4U, 0x6ee7d515U, 0x7de42d0aU);
            SCE->REG_1BCH = 0x00000040U;
            /* WAIT_LOOP */
            while (0U != SCE->REG_18H_b.B12)
            {
        ...
        {
            R_SCE_func100(0xfe3d92deU, 0xf9cf25fbU, 0x39866f77U, 0xf4f1c0b7U);
            ...
            SCE->REG_1CH = 0x00001800U;
            R_SCE_func100(0xabf45396U, 0x938df4c4U, 0xb439eb17U, 0xc9b5c7a5U);
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p36i_r1.prc
***********************************************************************************************************************/
