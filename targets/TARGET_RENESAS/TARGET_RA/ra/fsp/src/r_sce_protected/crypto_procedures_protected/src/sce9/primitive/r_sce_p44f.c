...
fsp_err_t R_SCE_Aes256CmacFinalSub(uint32_t *InData_Cmd, uint32_t *InData_Text, uint32_t *InData_DataT, uint32_t *InData_DataTLen, uint32_t *OutData_DataT)
{
    uint32_t iLoop    = 0U;
    uint32_t iLoop1   = 0U;
    uint32_t iLoop2   = 0U;
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    R_SCE_func100(0x3c99268aU, 0xe56ce5cdU, 0x32be5a4fU, 0xe39bce14U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        R_SCE_func102(0x0caeb77fU, 0x6c7a25ebU, 0x72a43244U, 0x8df6d1dcU);
    ...
    else
    {
        if ((InData_Cmd[0] == 0x00000000U) || (InData_Cmd[0] == 0x00000002U))
        {
            ...
            R_SCE_func101(0xfd2e6958U, 0x9a7bd1eaU, 0x6a3e0bb4U, 0x433d7c1dU);
        }
        else
        {
            SCE->REG_104H = 0x00000051U;
            ...
            SCE->REG_100H = change_endian_long(0x00000000U);
            R_SCE_func101(0x0b0487f7U, 0xa16daf98U, 0x28b00b2dU, 0x5b41d76aU);
        }
        ...
        {
            R_SCE_func100(0xcd42a58cU, 0xa9facab0U, 0x1ff04d18U, 0x7df762c9U);
            ...
            R_SCE_func102(0xd240bfa2U, 0x20607f20U, 0xea5ffc9aU, 0xbcda7f4fU);
            SCE->REG_1BCH = 0x00000040U;
            /* WAIT_LOOP */
            while (0U != SCE->REG_18H_b.B12)
            {
        ...
        else
        {
            ...
            SCE->REG_E0H = 0x00000080U;
            SCE->REG_1CH = 0x00260000U;
            R_SCE_func100(0x4cdb1e5fU, 0x7d48183dU, 0xce648b35U, 0xb2cb1eddU);
            SCE->REG_1CH = 0x00400000U;
            SCE->REG_1D0H = 0x00000000U;
            if (1U == (SCE->REG_1CH_b.B22))
            {
                R_SCE_func102(0xd4840de4U, 0x7e04fdb3U, 0x328f5ff6U, 0xb59e7936U);
                SCE->REG_1BCH = 0x00000040U;
                /* WAIT_LOOP */
                while (0U != SCE->REG_18H_b.B12)
                {
            ...
            else
            {
                ...
                R_SCE_func100(0xfc7d371bU, 0x98382b69U, 0x94b36463U, 0xf8affb93U);
                SCE->REG_1CH = 0x00400000U;
                SCE->REG_1D0H = 0x00000000U;
                if (1U == (SCE->REG_1CH_b.B22))
                {
                    R_SCE_func102(0x36dd3a0fU, 0x555b2131U, 0x0cf8896aU, 0xa402ff55U);
                    SCE->REG_1BCH = 0x00000040U;
                    /* WAIT_LOOP */
                    while (0U != SCE->REG_18H_b.B12)
                    {
                ...
                {
                    R_SCE_func102(0x4bcb12d8U, 0xb4d7fa3cU, 0xf015b3c8U, 0xe3378a56U);
                    SCE->REG_1BCH = 0x00000040U;
                    /* WAIT_LOOP */
                    while (0U != SCE->REG_18H_b.B12)
                    {
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p44f_r1.prc
***********************************************************************************************************************/
