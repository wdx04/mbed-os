...
fsp_err_t R_SCE_Rsa2048ModularExponentDecryptSub(uint32_t *InData_KeyIndex, const uint32_t *InData_Text, uint32_t *OutData_Text)
{
    uint32_t iLoop    = 0U;
    uint32_t iLoop1   = 0U;
    uint32_t iLoop2   = 0U;
    ...
    R_SCE_func101(0x101a4f3fU, 0x890709bdU, 0xa19ab822U, 0x22cddc9fU);
    R_SCE_func043();
    ...
    SCE->REG_100H = change_endian_long(0x00000057U);
    R_SCE_func101(0x79521f65U, 0x25404e2bU, 0xc0275b33U, 0x77d58bbaU);
    R_SCE_func044();
    ...
    SCE->REG_1CH = 0x00001800U;
    R_SCE_func100(0x749acb4cU, 0x43467e72U, 0xa630450bU, 0xc4de5b59U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        R_SCE_func102(0x282712a3U, 0xbc66da2eU, 0x2f91eb35U, 0xbb70eddfU);
    ...
    {
        R_SCE_func100(0x77153f5dU, 0x3fe9b986U, 0xb83f3d45U, 0x2facdd3aU);
        ...
        R_SCE_func100(0x6278f89dU, 0xc5512232U, 0xeda389acU, 0x5cc606c3U);
        ...
        R_SCE_func102(0xca06c470U, 0xb9809f5eU, 0x7749719aU, 0x10d8c9bfU);
        SCE->REG_1BCH = 0x00000040U;
        /* WAIT_LOOP */
        while (0U != SCE->REG_18H_b.B12)
        {
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p57_r1.prc
***********************************************************************************************************************/
