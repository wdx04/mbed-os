...
fsp_err_t R_SCE_Aes256CcmEncryptInitSub(uint32_t *InData_KeyType, uint32_t *InData_KeyIndex, uint32_t *InData_IV, uint32_t *InData_Header, uint32_t Header_Len)
{
    uint32_t iLoop    = 0U;
    uint32_t iLoop1   = 0U;
    uint32_t iLoop2   = 0U;
    ...
    R_SCE_func100(0x071514dbU, 0x728f6e48U, 0x01017c18U, 0xaf4cc6f1U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        R_SCE_func102(0x80485ee5U, 0x3da78749U, 0x79647f5fU, 0x97d47768U);
    ...
    else
    {
        ...
        SCE->REG_E0H = 0x00000080U;
        SCE->REG_1CH = 0x00260000U;
        R_SCE_func100(0x9a1c3c30U, 0xd234a55dU, 0x8ac4d064U, 0xce307dd8U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            R_SCE_func101(0x2bf186e2U, 0x3887d856U, 0x15873b61U, 0xdcc23130U);
            R_SCE_func043();
            SCE->REG_ECH = 0x0000b4e0U;
            SCE->REG_ECH = 0x00000007U;
            R_SCE_func101(0x692b9713U, 0x0c998b99U, 0xa33e14fdU, 0x7b09f9aaU);
        }
        else
        {
            SCE->REG_104H = 0x00000068U;
        ...
        SCE->REG_100H = change_endian_long(0x000000a1U);
        R_SCE_func101(0x323ef535U, 0x7fa15f30U, 0x45e966f6U, 0xb68289c5U);
        R_SCE_func044();
        ...
        R_SCE_func100(0xd6ae99d4U, 0x4c760dc6U, 0x4ac6e1ecU, 0xbcd5c657U);
        ...
        SCE->REG_1CH = 0x00001800U;
        R_SCE_func100(0x93a9b8c2U, 0xcf932627U, 0x9c07a703U, 0x3bef7573U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            R_SCE_func102(0xb54d6f35U, 0xd3b9f14eU, 0x15287d7dU, 0x2f6b652bU);
            SCE->REG_1BCH = 0x00000040U;
            /* WAIT_LOOP */
            while (0U != SCE->REG_18H_b.B12)
            {
        ...
        else
        {
            ...
            R_SCE_func100(0x1b770fd3U, 0x6ab3717bU, 0xc037592dU, 0x15a122adU);
            SCE->REG_1CH = 0x00400000U;
            SCE->REG_1D0H = 0x00000000U;
            if (1U == (SCE->REG_1CH_b.B22))
            {
                R_SCE_func102(0x2b58d3a9U, 0xe40af2c1U, 0x4c755500U, 0x4a1b04b4U);
                SCE->REG_1BCH = 0x00000040U;
                /* WAIT_LOOP */
                while (0U != SCE->REG_18H_b.B12)
                {
