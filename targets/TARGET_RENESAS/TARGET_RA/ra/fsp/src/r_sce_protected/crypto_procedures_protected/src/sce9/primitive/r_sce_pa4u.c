...
void R_SCE_Aes256CcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    R_SCE_func100(0xe8b2bbf8U, 0xfe89748eU, 0x7bd1cc87U, 0xa994a8e6U);
    ...
    R_SCE_func101(0xab9c3adeU, 0x73c1e819U, 0x4092a6dbU, 0x392d9b6bU);
}

/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_pa4u_r1.prc
***********************************************************************************************************************/
